      ...
      <div style={{ display: "flex" }}>
        ...
        <div className={styles.commentReplyAuthorAvatarContainer}>
          <Link href={`/profile/${commentReply.author.username}/`}>
            <Image
              src={
                commentReply.post.blog.avatar_smal
                  ? `${BASE_URL}${commentReply.post.blog.avatar_small}`
              ...
              {commentReply.liked_by_author.toString() === "true" ? (
                <div
                  className={classNames(styles.likedByAuthor, {
                    [styles.active]:
                      user.username === commentReply.post.author.username,
                  })}
                  onClick={setOrRemoveLikeByAuthorButton}
                >
                  <Image
                    src={
                      commentReply.post.author.avatar_small
                        ? `${BASE_URL}${commentReply.post.author.avatar_small}`
                        : "/img/default/avatar_default.jpg"
                    }
