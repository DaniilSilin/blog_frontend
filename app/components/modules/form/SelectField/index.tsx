          ...
          <Space>
            <span role="img" aria-label={option.data.username}>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <Image src={option.data.avatar_small ? `${BASE_URL}${option.data.avatar_small}` : '/img/default/avatar_default.jpg'} className={styles.userAvatar} width={40} height={40} alt='' />
                <div>
