...
export default function CropCroppedImage({ avatar, imageSourceUrl, username, sourceImage }) {
  ...
  const onCropChange = React.useCallback((pixelCrop: any) => {
    setCrop(pixelCrop)
    setCanvasPreview(
      imgRef.current,
  ...
  return (
    <div>
      ...
      <div>Выберите область для маленьких фотографий. Выбранная миниатюра будет использоваться в новостях, личных сообщениях и комментариях.</div>
      <ReactCrop
        crop={crop}
      ...
      {avatar && (<img src={dataUrl} style={{ borderRadius: '50%', marginRight: '20px' }} width={40} height={40} alt='' />)}
