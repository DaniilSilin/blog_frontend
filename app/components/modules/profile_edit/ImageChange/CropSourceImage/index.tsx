...
export default function CropSourceImage({ imageSourceUrl, username, sourceImage }: Props) {
  ...
  if (avatar) {
    return <CropCroppedImage avatar={avatar} imageSourceUrl={imageSourceUrl} username={username} sourceImage={sourceImage} />
  }
  ...
  return (
    <div>
      ...
      <div>Выбранная область будет показываться на вашей странице. Если изображение ориентировано неправильно, фотографию можно повернуть.</div>
      <ReactCrop
        crop={crop}
