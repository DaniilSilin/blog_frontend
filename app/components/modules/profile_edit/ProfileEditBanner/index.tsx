...
import styles from "./profile_edit_banner.module.css";
  ...
  return (
    <div>
      ...
      <div className={styles.bannerContainerDescription}>
        Это изображение показывается в верхней части Вашей страницы.
      </div>
      <div className={styles.bannerImageContainer}>
        ...
        <div className={styles.avatarUploadContainer}>
          <div className={styles.bannerGuide}>
            Чтобы Ваш профиль выглядел привлекательно, советуем загрузить
            изображение размером не менее 2048 x 1152 пикс. Размер файла – не
            более 6 МБ.
          </div>
